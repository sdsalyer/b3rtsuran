...
/* b3rtsuran
   ...
   */
   ...
   [_BL] = LAYOUT_buran(
        ...
        KC_A,        KC_S,        KC_D,        KC_F,        KC_G,                       KC_H,        KC_J,        KC_K,        LT(_FFL,KC_L),  KC_SCOLON,
        KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,                       KC_N,        KC_M,        KC_COMMA,    KC_DOT,        KC_SLASH,
        KC_LCTRL,    MO(_FL),     KC_LGUI,     LT(_BL,KC_SPACE),                        KC_BSPACE,   KC_RALT,     MO(1),       KC_LSHIFT
...
/* b3rtsuran
  ...
  */
   [_FL] = LAYOUT_buran(
        ...
        KC_LALT,     KC_NO,       KC_NO,       KC_NO,                                    KC_DEL,      KC_NO,     KC_NO,       KC_NO
